...
import com.liferayscala.NoSuchEmployeeException;

import com.liferayscala.model.Employee;
import com.liferayscala.model.impl.EmployeeImpl;
import com.liferayscala.model.impl.EmployeeModelImpl;

import com.liferayscala.service.persistence.EmployeePersistence;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
    ...
    @Override
    public Employee updateImpl(com.liferayscala.model.Employee employee)
        throws SystemException {
        employee = toUnwrappedModel(employee);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.liferayscala.model.Employee")));
